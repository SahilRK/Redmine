...
ActiveRecord::Schema.define(:version => 20140228130325) do
  ...
  create_table "execution_journals", :force => true do |t|
  ...
  create_table "execution_results", :force => true do |t|
    t.string  "name",         :null => false
    t.integer "order_number"
  end

  add_index "execution_results", ["name"], :name => "index_execution_results_on_name", :unique => true

  create_table "execution_suite_test_case", :id => false, :force => true do |t|
    t.integer "execution_suite_id", :null => false
    t.integer "test_case_id",       :null => false
  end

  add_index "execution_suite_test_case", ["execution_suite_id", "test_case_id"], :name => "execution_suite_test_case_index", :unique => true

  create_table "execution_suites", :force => true do |t|
    t.string  "name",       :limit => 128, :null => false
    t.integer "parent_id"
    t.integer "project_id"
  end

  add_index "execution_suites", ["name", "parent_id"], :name => "index_execution_suites_on_name_and_parent_id", :unique => true
  ...
  add_index "test_cases", ["test_suite_id", "issue_id"], :name => "test_suite_test_case_index", :unique => true
  ...
  add_index "test_suites", ["name", "parent_id"], :name => "index_test_suites_on_name_and_parent_id", :unique => true
